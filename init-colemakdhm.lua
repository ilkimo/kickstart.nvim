...
vim.api.nvim_set_keymap('n', 'P', 'R', { noremap = true })
vim.api.nvim_set_keymap('n', 'b', 't', { noremap = true })
vim.api.nvim_set_keymap('n', 'B', 'T', { noremap = true })
...
vim.api.nvim_set_keymap('n', 'I', 'L', { noremap = true })
vim.api.nvim_set_keymap('n', '<S-o>', ':', { noremap = true })
vim.api.nvim_set_keymap('n', '\'', '\'', { noremap = true })
vim.api.nvim_set_keymap('n', '\"', '\"', { noremap = true })
vim.api.nvim_set_keymap('n', 'x', 'z', { noremap = true })
vim.api.nvim_set_keymap('n', 'X', 'Z', { noremap = true })
...
vim.api.nvim_set_keymap('n', 'V', 'V', { noremap = true })
vim.api.nvim_set_keymap('n', 'z', 'b', { noremap = true })
vim.api.nvim_set_keymap('n', 'Z', 'B', { noremap = true })
vim.api.nvim_set_keymap('n', 'k', 'n', { noremap = true })
vim.api.nvim_set_keymap('n', 'K', 'N', { noremap = true })
vim.api.nvim_set_keymap('n', 'h', 'm', { noremap = true })
vim.api.nvim_set_keymap('n', 'H', 'M', { noremap = true })
vim.api.nvim_set_keymap('n', ',', ',', { noremap = true })
vim.api.nvim_set_keymap('n', '<', '<', { noremap = true })
vim.api.nvim_set_keymap('n', '.', '.', { noremap = true })
...
-- Remap insert mode movement shortcuts ('mode', 'colemak', 'mapped to')
